...
def get_evaluate_fn(model):
    ...
    def evaluate(
        ...
        if (server_round == federatedLearningcounts):
            ...
            model.save('saved_models/mobilenetv2.keras')  # save model in .h5 format
...
def ei_profile_and_deploy_model(model):
    ...
    try:
        ...
        print(f"Could not list_profile_devices: {e}")
